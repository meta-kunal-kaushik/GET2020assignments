...
var passwordStrength = function() {
    var password = document.getElementById("pass").value; //type assertion is done to use .value property
    var returnVal = false;
...
var isPasswordAndConfirmPassMatch = function() {
...
var isCorrectVehicleName = function() {
    setEmpId();
    var vehicleName = document.getElementById('VehicleName').value;
    var returnVal = false;
...
var isCorrectVehicleType = function() {
    var vehicleType = document.getElementById('VehicleType').value;
    var returnVal = false;
