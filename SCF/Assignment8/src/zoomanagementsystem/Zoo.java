...
/**
 * this class implements Zoo Management System
 */
     ...
     */
    public boolean addZone(int capacityOfCages, String zoneType, boolean park,
            boolean canteen) {
    ...
    public boolean addCage(String zoneType, String animalBreed, int capacity) {
        ...
        for (int i = 0; i < listOfZones.size(); i++) {
            if (listOfZones.get(i).typeOfZone == zoneType
                    && listOfZones.get(i).limitOfCages > listOfZones.get(i).listOfCages
                            .size()) {
     ...
     */
    public boolean addAnimal(String type, int age, String name,
            String category, float weight, int speed, String sound)
            throws AssertionError {
        Animal animalObj = AnimalTypeFactory.addAnimal(type, age, name,
                category, weight, speed, sound);
        System.out.println("ïn 1");
        for (int i = 0; i < listOfZones.size(); i++) {
            if (listOfZones.get(i).typeOfZone == category) {
                for (int j = 0; j < listOfZones.get(i).listOfCages.size(); j++) {
                    if (listOfZones.get(i).listOfCages.get(j).listOfAnimal
                            .containsKey(name))
                        throw new AssertionError(
                                "Animal with this name already present");
                    if (listOfZones.get(i).listOfCages.get(j).animalBreed == type
                            && listOfZones.get(i).listOfCages.get(j).capacityOfCage > listOfZones
                                    .get(i).listOfCages.get(j).listOfAnimal
                                    .size()) {
                        listOfZones.get(i).listOfCages.get(j).listOfAnimal.put(
                                name, animalObj);
                        return true;
                    }
                }
     ...
     */
    public boolean addAnimal(String type, int age, String name,
            String category, float weight, boolean canFly, String sound)
            throws AssertionError {
        Animal animalObj = AnimalTypeFactory.addAnimal(type, age, name,
                category, weight, canFly, sound);
     ...
     */
    public boolean addAnimal(String type, int age, String name,
            String category, float weight, String swim, String sound)
            throws AssertionError {
        Animal animalObj = AnimalTypeFactory.addAnimal(type, age, name,
                category, weight, swim, sound);
        System.out.println("ïn 1");
        for (int i = 0; i < listOfZones.size(); i++) {
            if (listOfZones.get(i).typeOfZone == category) {
                for (int j = 0; j < listOfZones.get(i).listOfCages.size(); j++) {
            ...
            if (listOfZones.get(i).typeOfZone == category) {
                for (int j = 0; j < listOfZones.get(i).listOfCages.size(); j++) {
                    if (listOfZones.get(i).listOfCages.get(j).animalBreed == breed
                            && listOfZones.get(i).listOfCages.get(j).listOfAnimal
                                    .containsKey(name)) {
                        listOfZones.get(i).listOfCages.get(j).listOfAnimal
                                .remove(name);
                        return true;
     ...
     */
    public String getAnimalSound(String category, String breed, String name)
            throws AssertionError {
        for (int i = 0; i < listOfZones.size(); i++) {
            if (listOfZones.get(i).typeOfZone == category) {
                for (int j = 0; j < listOfZones.get(i).listOfCages.size(); j++) {
                    if (listOfZones.get(i).listOfCages.get(j).animalBreed == breed) {
                        return listOfZones.get(i).listOfCages.get(j).listOfAnimal
                                .get(name).getSound();
                    }
                }
            }
    ...
    public static void main(String[] args) {
        ...
        check = obj
                .addAnimal("tiger", 10, "ramu", "mammal", 50.00f, 65, "roar");
        System.out.println(check);
        ...
        check = obj.addAnimal("eagle", 5, "chiya", "bird", 10.00f, check,
                "beep");
        System.out.println(check);
