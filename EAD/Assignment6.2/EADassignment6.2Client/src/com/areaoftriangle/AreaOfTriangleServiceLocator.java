...
public class AreaOfTriangleServiceLocator extends org.apache.axis.client.Service implements com.areaoftriangle.AreaOfTriangleService {
    ...
    private java.lang.String AreaOfTriangle_address = "http://localhost:8081/EADassignment6.2/services/AreaOfTriangle";
    ...
    public com.areaoftriangle.AreaOfTriangle getAreaOfTriangle() throws javax.xml.rpc.ServiceException {
    ...
    public com.areaoftriangle.AreaOfTriangle getAreaOfTriangle(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.areaoftriangle.AreaOfTriangleSoapBindingStub _stub = new com.areaoftriangle.AreaOfTriangleSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.areaoftriangle.AreaOfTriangle.class.isAssignableFrom(serviceEndpointInterface)) {
                com.areaoftriangle.AreaOfTriangleSoapBindingStub _stub = new com.areaoftriangle.AreaOfTriangleSoapBindingStub(new java.net.URL(AreaOfTriangle_address), this);
                _stub.setPortName(getAreaOfTriangleWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://areaoftriangle.com", "AreaOfTriangleService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://areaoftriangle.com", "AreaOfTriangle"));
        }
